...
TEST_CASE( "face 1 different than face 2", "[die]" )
{
...
TEST_CASE( "face 2 greater than face 1", "[die]" )
{
...
TEST_CASE( "face 1 less than face 2", "[die]" )
{
	risk::die::die_face face1{1};
	risk::die::die_face face2{2};
	REQUIRE( face1 < face2 );
...
TEST_CASE( "face 3  equals face 3", "[die]" )
{
...
TEST_CASE( "sorting dice 1, 2 e 3", "[die]" )
{
...
TEST_CASE( "defense die wins if draw", "[die]" )
{
...
TEST_CASE( "defense die wins if the value is greater than attack", "[die]" )
{
...
TEST_CASE( "defense die loses if the value is lower than attack", "[die]" )
{
...
TEST_CASE( "attack die wins if the value is greater than defense", "[die]" )
{
	const risk::die::land_defense_die_face defense{3};
...
TEST_CASE( "attack die loses if the value is lower than defense", "[die]" )
{
	const risk::die::land_defense_die_face defense{3};
...
TEST_CASE( "atack loses wins if draw", "[die]" )
{
	const risk::die::land_defense_die_face defense{3};
	const risk::die::land_attack_die_face attack{3};
...
TEST_CASE( "die land fight attack wins", "[die]" )
{
...
TEST_CASE( "die land fight defense wins", "[die]" )
{
